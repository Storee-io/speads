              ...
              <div className="lg:w-1/2">
                ...
                <div className="space-y-8">
                    {audiences.map((item, index) => (
                      ...
                      <div>
                        <h3 className="font-heading text-xl font-bold mb-2 text-slate-900">{item.type}</h3>
                ...
                <div className="lg:w-1/2 relative">
                  ...
                  <div className="space-y-4 pt-12">
                    <Image
                      ...
                      width={400}
                      height={600}
                      className="rounded-2xl object-cover h-64 w-full shadow-xl border border-slate-100"
                    />
                    <Image
                      ...
                      width={400}
                      height={600}
                      className="rounded-2xl object-cover h-80 w-full shadow-xl border border-slate-100"
                    />
                  </div>
                  <div className="space-y-4">
                    <Image
                      ...
                      width={400}
                      height={600}
                      className="rounded-2xl object-cover h-96 w-full shadow-xl border border-slate-100"
                    />
                    <div className="bg-gradient-to-br from-indigo-600 to-indigo-500 p-8 rounded-2xl text-white flex flex-col justify-end h-48 shadow-xl shadow-indigo-500/20">
